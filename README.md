...
![Four Cases](superjoin-fact-layer/docs/screenshots/01_four_cases_evaluation.png)
...
![Facts Repository](superjoin-fact-layer/docs/screenshots/02_facts_repository.png)
...
![Cross Document Reasoning](superjoin-fact-layer/docs/screenshots/03_cross_document_reasoning.png)
...
![Schema Evolution](superjoin-fact-layer/docs/screenshots/04_schema_evolution.png)
...
![Knowledge Graph](superjoin-fact-layer/docs/screenshots/05_interactive_knowledge_graph.png)
...
![Diagnostic Audit Trail](superjoin-fact-layer/docs/screenshots/06_diagnostic_audit_trail.png)
...
<p align="center">
  <video src="superjoin-fact-layer/docs/superjoin_demo_walkthrough.webm" width="100%" controls="controls" preload="metadata">
    Your browser does not support the video tag.
  </video>
</p>

🎬 **[▶️ Click here to open/download the Demo Video (MP4)](superjoin-fact-layer/docs/superjoin_demo_walkthrough.mp4)**  
